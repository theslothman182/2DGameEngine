...
{
    class WalkDown : PlayerState
    {
        ///////////////////////////////////////  CONSTRUCTOR  /////////////////////////////////////


        // USE: the base constructor
        public WalkDown(ContentManager content) : base(content)//, GraphicsDevice gd) : base(content)//, gd)
        {
        ...
        public override void Update(GameTime dT, ContentManager content, Vector2 position)
        {
            ...
            if (keystate.IsKeyDown(Keys.S))
            {
                ...
                animMgr.Animate(dT, content, "walkdown", 4, 48, 40, 70);

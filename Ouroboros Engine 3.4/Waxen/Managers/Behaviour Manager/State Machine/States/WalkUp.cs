...
{
    class WalkUp : PlayerState
    {
        ///////////////////////////////////////  CONSTRUCTOR  /////////////////////////////////////


        // USE: the base constructor
        public WalkUp(ContentManager content) : base(content)//, GraphicsDevice gd) : base(content)//, gd)
        {
        ...
        public override void Update(GameTime dT, ContentManager content, Vector2 position)
        {
            ...
            {
                // ANIMATE: the sprite for walking up
                animMgr.Animate(dT, content, "walkup", 4, 48, 40, 70);
